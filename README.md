...
State-of-the-art satellite remote sensing data has been INTEGRATED with GIS across disciplines like agriculture, forestry, urban etc., with ancillary data like knowledge/literature-based and ground observations of features on the Earth’s surface to protect the natural resources, mitigate disasters and forecast natural calamities. The quest for high resolution and accurate information has escalated the demand for sensors like Sentinel and Planet labs [Ammani et al., 2021], which produces data in the order of the Terabyte scale. Contemporary developments in data science packages (e.g., TensorFlow, PyTorch) and containerization (e.g., docker) facilitated interoperability and allowed us to analyze this Terabyte scale sensor data. Moreover, with current  approaches  in computing capabilities, global-scale analysis is performed efficiently by connecting to a remote data infrastructure (e.g., Raspberry Shake, IRIS seismic data is housed in a cloud). The limitations of desktop computing are overcome through cheaper cloud computing resources. For example, a collaborative effort between Google developers and Earth science researchers enables us to update the algorithms and datasets on cloud (e.g., through GCP, AWS, Azure). Also, Hansen et al., 2013 utilized the vast repository of 40 years of data in GEE to compute global forest cover change (2000- 2020). Global Forest Watch was developed based on the capabilities of GEE.  The introduction of interactive, user-friendly interfaces with various informatics tools has empowered people to analyze data on the fly and derive results.
